...
class ExplicitGCodeTest {
    ...
    public void testFillReferences01(){
        ...
        table.openScope();
        table.enterSymbol("myNum", GMMType.Num, new LiteralNumber(500));
    ...
    public void testFillReferences02(){
        ...
        table.openScope();
        table.enterSymbol("myNum", GMMType.Num, new LiteralNumber(500));
        table.enterSymbol("neirv475_5dW", GMMType.Num, new LiteralNumber(8492.48423));
    ...
    public void testFillReferences03(){
        ...
        table.openScope();
        table.enterSymbol("myNum", GMMType.Num, new LiteralNumber(500));
        table.enterSymbol("gew___wfwgrw", GMMType.Num, new LiteralNumber(-5));
        table.enterSymbol("neirv475_5dW", GMMType.Num, new LiteralNumber(10485492.48423));
    ...
    public void testFillReferences05(){
        ...
        ISymbolTable table = new SymbolTable();
        table.openScope();
        table.enterSymbol("myBool", GMMType.Bool, new LiteralBool(true));
